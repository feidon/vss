...
def create_node_layouts() -> dict[UUID, tuple[float, float]]:
    ...
    return {
        YARD_ID: (0.0, 150.0),
        b["B1"]: (75.0, 100.0), b["B2"]: (75.0, 200.0),
        p["P1A"]: (150.0, 100.0), p["P1B"]: (150.0, 200.0),
        b["B3"]: (225.0, 75.0), b["B4"]: (225.0, 175.0), b["B5"]: (300.0, 125.0),
        p["P2A"]: (375.0, 100.0), p["P2B"]: (375.0, 200.0),
        b["B6"]: (450.0, 100.0), b["B7"]: (525.0, 75.0), b["B8"]: (525.0, 125.0),
        p["P3A"]: (600.0, 75.0), p["P3B"]: (600.0, 125.0),
        b["B10"]: (525.0, 225.0), b["B9"]: (525.0, 275.0), b["B11"]: (450.0, 250.0),
        b["B12"]: (300.0, 225.0), b["B13"]: (225.0, 225.0), b["B14"]: (225.0, 275.0),
    }
