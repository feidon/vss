...
Revision ID: abf376265719
Revises:
Create Date: 2026-04-04 22:54:27.219757
...
def upgrade() -> None:
    ...
    op.create_table(
        "junction_blocks",
        sa.Column("from_block_id", sa.Uuid(), nullable=False),
        sa.Column("to_block_id", sa.Uuid(), nullable=False),
        sa.Column("junction_id", sa.Uuid(), nullable=False),
        sa.ForeignKeyConstraint(["junction_id"], ["node_layouts.node_id"]),
        sa.PrimaryKeyConstraint("from_block_id", "to_block_id"),
    )
