...
class TestVehicleConflicts:
    def test_no_conflicts(self):
        ...
        conflicts = ConflictDetectionService.detect_vehicle_conflicts(vid, [s1, s2])
        assert conflicts == []
...
class TestBlockConflicts:
    def test_no_conflicts(self):
        ...
        conflicts = ConflictDetectionService.detect_block_conflicts([s1, s2], [block])
        assert conflicts == []
    ...
    def test_finds_all_overlapping_pairs(self):
        ...
        conflicts = ConflictDetectionService.detect_block_conflicts([sa, sb, sc], [block])
