    ...
    def test_no_route_raises(self, connections, block_ids):
        ...
        with pytest.raises(ValueError, match="No route"):
            RouteFinder.find_block_chain(
                PLATFORM_ID_BY_NAME["P2A"], PLATFORM_ID_BY_NAME["P1A"], connections, block_ids
            )
...
class TestBuildFullPath:
    def test_two_stops(self, connections, block_ids):
        ...
        assert result == [
            ...
            BLOCK_ID_BY_NAME["B3"], BLOCK_ID_BY_NAME["B5"],
            PLATFORM_ID_BY_NAME["P2A"],
        ]

    def test_three_stops(self, connections, block_ids):
        result = RouteFinder.build_full_path(
            [PLATFORM_ID_BY_NAME["P1A"], PLATFORM_ID_BY_NAME["P2A"], PLATFORM_ID_BY_NAME["P3A"]],
        ...
        assert result == [
            ...
            BLOCK_ID_BY_NAME["B3"], BLOCK_ID_BY_NAME["B5"],
            PLATFORM_ID_BY_NAME["P2A"],
            BLOCK_ID_BY_NAME["B6"], BLOCK_ID_BY_NAME["B7"],
    ...
    def test_full_loop(self, connections, block_ids):
        ...
        result = RouteFinder.build_full_path(
            [
                ...
                PLATFORM_ID_BY_NAME["P3A"], PLATFORM_ID_BY_NAME["P2B"],
                PLATFORM_ID_BY_NAME["P1A"],
            ],
            connections, block_ids,
        )
        assert result == [
            ...
            BLOCK_ID_BY_NAME["B6"], BLOCK_ID_BY_NAME["B7"],
            PLATFORM_ID_BY_NAME["P3A"],
            BLOCK_ID_BY_NAME["B10"], BLOCK_ID_BY_NAME["B11"],
            PLATFORM_ID_BY_NAME["P2B"],
            BLOCK_ID_BY_NAME["B12"], BLOCK_ID_BY_NAME["B13"],
            PLATFORM_ID_BY_NAME["P1A"],
        ]
